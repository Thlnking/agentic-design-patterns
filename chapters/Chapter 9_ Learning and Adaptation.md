...
学习和适应对于增强人工智能智能体力至关重要。这些过程使智能智能体预定义参数进行演化，通过经验和环境交互实现自主改进。通过学习和适应，智能体可以有效应对新情况并优化其性能，而无需持续的人工干预。本章将深入探讨支撑智能体学智能体原理与机制。
...
智能体基于学习结果改变策略、理解或目标来实现适应。这对于在不可预测、变化或新环境中的智能体重要。

**近端策略优化（PPO）** 是一种强化学习算法，用于在具有连续动作范围的环境中训练智能体，例如控制机器人的关节或游戏中的角色。其主要目标是可靠且稳定地改进智能体策策略（即其策略）。

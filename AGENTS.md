...
- **技术栈**: VitePress、Markdown、Node.js、GitHub Pages
...
- 已安装 Node.js
- 可选安装 Ruby / Bundler（仅在需要维护历史 Jekyll 或周边脚本时）
...
- 未经维护者明确批准，不得修改 `site/.vitepress/` 中的站点配置
- 未经过讨论不得新增依赖或插件
...
- 上一章/下一章导航在三种版本间正常工作
- 使用 `site/.vitepress/` 中的主题配置和组件渲染双语页面
- 通过 VitePress 的导航、侧边栏和阅读模式切换组件提供双语版导航
